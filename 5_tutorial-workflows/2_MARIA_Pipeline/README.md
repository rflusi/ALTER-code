...
The files ALTER4_Mutant_Peptides.tsv, ALTER4_Mutant_Peptides_MARIA_input.txt, and  will be generated by running the pipeline but are too large to feasibly upload to this repository. MARIA installation should first be validated using the sample files available with the MARIA repository.

The files ALTER4_Mutant_Peptides_Trunc.tsv, ALTER4_Mutant_Peptides_MARIA_Input_Trunc.txt, and ALTER4_Mutant_Peptides_MARIA_Input_Trunc.txt.output.txt are provided as truncated versions for formatting and validation.
