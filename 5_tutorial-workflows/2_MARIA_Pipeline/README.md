...
The files ALTER4_Mutant_Peptides.tsv and ALTER4_Mutant_Peptides_MARIA_input.txt will be generated by running the pipeline but are too large to feasibly upload to this repository. MARIA installation should first be validated using the sample files available with the MARIA repository.
